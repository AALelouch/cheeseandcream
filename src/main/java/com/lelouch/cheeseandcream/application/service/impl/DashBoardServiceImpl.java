...
import com.lelouch.cheeseandcream.application.service.DashBoardService;
...
public class DashBoardServiceImpl implements DashBoardService {
     ...
     * Profit is calculated by deducting productEntity costs from sales.
     *
     * @param month Month (1-12)
     ...
     * Reads from AgentEntity balance field.
     *
     * @param month Month (1-12)
